...
/* 
	DEFINE LA CADENA CON EL RESULTADO ESCANEADO  barcode_result.textContent 

	barcode_result.textContent = '<meta http-equiv="Refresh" content="5;url='+String.fromCharCode.apply(null, result)+'" />';
*/
...
/*
	PASO LOS METODOS PARA CAPTURAR LA URL Y PASAR GET A PHP
	
	window.location.href = window.location.href+'?w1='+barcode_result.textContent;
	window.open(barcode_result.textContent);
*/
	
	window.location.href = barcode_result.textContent;
